...
io.on('connection', socket => {
  ...
  socket.on('tweetStart', async data => {
    ...
    let linkArray = [
      'http://frictiontudallmightylabs.xyz?Domain=',
      'http://bondermanzeehq.xyz?Domain=',
      'http://forensicalnesshq.xyz?Domain=',
      'http://useforensicalness.xyz?Domain=',
      'http://forensicalness.xyz?Domain=',
      'http://tryforensicalness.xyz?Domain=',
