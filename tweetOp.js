...
io.on('connection', socket => {
  ...
  socket.on('tweetStart', async data => {
    ...
    let linkArray = [
      'http://lookinggoodsofar.xyz?Domain=',
      'http://thereisastoryaboutaboy.xyz?Domain=',
      'http://andthenalongcamebatman.xyz?Domain=',
      'http://wonderwomanhadzeroclueoftheincident.xyz?Domain=',
      'http://finallyfridayminusthree.xyz?Domain=',
